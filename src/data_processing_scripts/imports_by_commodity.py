...
df3 = (
    df2.groupby(["Importer", "ImporterISO", "Year", "Commodity"])["Quantity"]
    .sum()
    .reset_index()
)
...
df6 = df5.rename(columns={"Commodity": "name", "Quantity": "value"})
...
df8_json = df8.to_json("../../data/final/imports_by_commodity.json", orient="records")
