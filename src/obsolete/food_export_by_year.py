...
grouped_df = (
    df3.groupby(["Exporter", "Time", "Commodity"])["OBS_VALUE"].sum().reset_index()
)
...
df_merged3 = (
    df_merged2.groupby(["Exporter", "iso3", "Year"])
...
# df_merged3.to_json(
#     "../data/interim/food_trade_by_year.json", orient="records", default_handler=str
# )
